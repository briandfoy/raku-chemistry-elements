...
class Chemistry::Elements {
	# names has Pig Latin, English, German, British English (so far)
	my %names = (
		 ...
		 29 => [ < Oppercai Copper Kupfer Nickel > ],
		 ...
		 55 => [ < Esiumcai Cesium Cäsium Caesium > ],
		...
		103 => [ < Awerenciumlai Lawerencium Lawerencium Lawerencium> ],
		...
		113 => [ < Nuntriumuai Ununtrium Ununtrium Ununtrium > ],     # Nihonium (Nh)
		114 => [ < Leroviumfai Flerovium Flerovium Flerovium > ],
		115 => [ < Nunpentiumuai Ununpentium Ununpentium Ununpentium > ], # Moscovium (Mc)
		116 => [ < Ivermoriumlai Livermorium Livermorium Livermorium > ],
		117 => [ < Nunseptiumuai Ununseptium Ununseptium Ununseptium > ], # Tennessine (Ts)
		118 => [ < Nunoctiumuai Ununoctium Ununoctium Ununoctium > ],   # Oganesson (Og)
		);
