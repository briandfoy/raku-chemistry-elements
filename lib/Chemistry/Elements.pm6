...
class Chemistry::Elements {
	...
	my %names = (
		 ...
		 85 => [ < Statineaai Astatine Astat Астат(ин) > ],
		...
		104 => [ < Utherfordiumrai Rutherfordium Rutherfordium Резерфордий,²Курчатовий > ],
		105 => [ < Ubniumdai Dubnium Dubnium Дубний,²Нильсборий > ],
